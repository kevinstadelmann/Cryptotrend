...
df = pd.read_csv('../data/dirty/yahoo_oil_src_dirty.csv', header=None)
...
### Remove any wrong info - Only info about Oil using Filter with symbol
df2[df2.symbol == 'CL=F']
...
### Save cleaned file
df4.to_csv('../data/stage/yahoo_oil_stage.csv', index=False)